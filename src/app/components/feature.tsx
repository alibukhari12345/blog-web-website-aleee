      ...
      <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {paginatedData.map((val: FeatureType, i: number) => (
          <div key={i} className="py-1 w-[200px] es:w-[230px] md:w-[235px] xl:w-[300px] lg:w-[260px] hover:overflow-hidden  shadow-md shadow-slate-800 overflow-hidden">
            ...
            <h5 className='text-[13px] font-semibold hover:scale-105 transition duration-500'><span className='font-black text-yellow-500 underline text-[13px] mt-auto'>Solo Travel</span> by Ali Shah</h5>
          </div></div>
        ))}
      </div>
      {/* Pagination Controls */}
