  ...
  return (
    <div className='text-white flex flex-col'>
      ...
      <div className='flex justify-evenly mt-2 mb-2 mx-4 es:mx-0 '>
        {/*Logo */}
        <div>
          <h1 className='text-center mt-1 text-[9px] font-semibold text-white -500 leading-3 es:text-[10px] sm:text-[15px] scale-105'><strong className='text-yellow-400 font-black'>Al</strong>i  Trav<strong className='text-yellow-400'>el</strong> <br /> <strong className='text-sky-200 '>Guide</strong></h1>
        </div>
         <div>
